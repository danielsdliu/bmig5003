...
# So the hard part was actually the converting the NDA to a DFA.  Because of the way q1 and q3 are defined,
# the epsilon transition doesn't actually do anything (i.e. if you choose the epsilon step you're still going to go
# to q4 with a 1 and q3 with a 0 just like if you didn't have an epsilon step and fed q1 a 1 or a 0), but I thought
# it useful to work through the programming anyways so there is a state q1q3 function that ends up having the same
# output states as both q1 and q3.
